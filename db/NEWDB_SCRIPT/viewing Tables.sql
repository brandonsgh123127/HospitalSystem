...
SELECT p1.VisitID, p1.followUpID,p1.Date,p1.patientID, p1.PhysicianID,p2.lName,p2.fName,p2.DateOfBirth FROM visits AS p1 INNER JOIN patients AS p2 ON p1.PhysicianID=2808 and p1.patientID=p2.patientID;
